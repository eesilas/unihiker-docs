The UNIHIKER comes with samba service, allowing you to share files on the LAN. Using the Windows Network Neighborhood function, you can edit files just like managing Windows files.
## **How to Enable**
